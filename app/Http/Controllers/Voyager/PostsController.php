...
//        Важно
        ...
        $tagsForPost = $post->tags()->get();

//        Важно

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allTags','tagsForPost'));
    }
...
//        Важно
    ...
    public function store(Request $request)
    {
        ...
        $this->updatePostTags($request, $data->id);
